...
public class CommentController {
    ...
    // 댓글 좋아요
    @PostMapping("/{postId}/{id}/likes")
    public void likeComment(@PathVariable("postId") Long postId, @PathVariable("id") Long id, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        String username = userDetails.getUser().getUsername();
        commentService.likeComment(postId, id, username);
    }
}